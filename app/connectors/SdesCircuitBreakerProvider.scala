...
class SdesCircuitBreakerProvider @Inject() (
  ...
  private val maxFailures: Int = configuration.get[Int]("services.sdes.max-failures")
  private val callTimeout: FiniteDuration = configuration.get[FiniteDuration]("services.sdes.call-timeout")
  private val resetTimeout: FiniteDuration = configuration.get[FiniteDuration]("services.sdes.reset-timeout")
